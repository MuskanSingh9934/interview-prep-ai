...
const dummyPieData = [
  { name: 'Correct', value: 8, color: '#22C55E' },
  { name: 'Wrong', value: 2, color: '#EF4444' },
...
const feedback = {
  strengths: [
    ...
    "Excellent problem-solving approach for algorithmic questions.",
    "Good grasp of modern CSS features and responsive design."
  ],
  improvements: [
    "Could improve on explaining JavaScript closure concepts more clearly.",
    "Practice more advanced state management techniques.",
    "Work on pacing during technical explanations to be more concise."
  ]
};
  ...
  return (
    ...
    >
      <motion.div className="results-header" variants={itemVariants}>
        <h1 className="results-title">Outstanding Work, Muskan ✨</h1>
